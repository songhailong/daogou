(function () {
  ...
  window.goods = {
    ...
    cheOrderSuccess: function (params, responseCallback) {
    GoodsBridge.callHandler('cheOrderSuccess', params, responseCallback)
    },
    cheOrderSuccess3: function (params, responseCallback) {
    GoodsBridge.callHandler('cheOrderSuccess3', params, responseCallback)
    },
